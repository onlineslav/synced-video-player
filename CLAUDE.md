...
- **Audio quality:** WebRTC Opus is mono by default. `app.js` patches `setRemoteDescription` to add `stereo=1`. `tuneSenders` raises bitrate caps and scales video above 1080p down.
