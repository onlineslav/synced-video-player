...
- **Codec and smoothing:** `app.js` puts H.264 first via `setCodecPreferences` (hardware encode/decode on Mac and Windows; VP8 is software) and sets a 250ms receiver `jitterBufferTarget`.
