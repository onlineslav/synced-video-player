...
app.whenReady().then(async () => {
  ...
  try {
    ...
    await run(a, '__test.control("pause"); __test.removeFromPlaylist(__test.session.playing.id)')
    ...
    console.log('PASS: Removing the last selected video loads the previous video paused at its remembered timestamp')
